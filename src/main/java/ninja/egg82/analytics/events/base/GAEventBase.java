...
public class GAEventBase extends GAInputBase {
    ...
    protected GAEventBase(GameAnalytics ga, UUID userID, long sessionNum) {
        if (ga == null) {
    ...
    public static GAEventBase.Builder builder(GameAnalytics ga, UUID userID, long sessionNum) { return new GAEventBase.Builder(ga, userID, sessionNum); }

    public static class Builder {
        private final GAEventBase event;

        public Builder(GameAnalytics ga, UUID userID, long sessionNum) { event = new GAEventBase(ga, userID, sessionNum); }
